...
<body>
    ...
    <div class="small-container">
        <?php $id = $_GET['id'];?>
        <?php $brand = $_GET['brand'];?>
        <form action="" method="POST">
        <div class="row row2">
            
            <h2 style="color: black;">All <?php echo $brand?> Product</h2>
        ...
        <div class="row"> <?php 
            ...
            $sql = "SELECT * FROM product WHERE brand = '$id' AND active = 'Yes' ORDER BY $sort DESC";
